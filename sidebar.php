<div class="panel">
    ...
    <p><?php echo __("Status: %s", __($task->status)); ?></p>
    <?php endif; ?>
    <form action="<?php echo admin_url(array(), 'iiifapibridge_update') ?>" method="POST">
        ...
        <button type="submit" name="action_type" value="remove" class="big red button" style="width: 100%;"><?php echo __('Remove'); ?></button>
    </form>
</div>
